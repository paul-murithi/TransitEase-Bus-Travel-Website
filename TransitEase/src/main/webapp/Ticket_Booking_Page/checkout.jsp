...
<%
	if(session.getAttribute("username") == null){
		response.sendRedirect("/Pages/login_page/index.jsp");
	}
%>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="/Styles/TicketBookingPage/checkOut/checkout.css"
    />
  </head>
  ...
  <body>
    ...
    <script src="/scripts/TicketBookingPage/checkout.js"></script>
    <script src="/scripts/General scripts/toggleModal.js"></script>
  </body>
</html>
