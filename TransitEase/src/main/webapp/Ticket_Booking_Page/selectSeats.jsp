...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="/Styles/TicketBookingPage/selectSeat/selectSeat.css"
    />
  </head>
  ...
  <body>
    ...
    <div class="travelling-info-banner">
      ...
      <div class="destinations">
        <p id="Travel-from"></p>
        <img
          src="/Assets/images/icons8-bus-100 1.png"
          alt="bus icon"
        />
        <p id="travel-to"></p>
      </div>
    ...
    <script src="/scripts/TicketBookingPage/generatepage.js"></script>
