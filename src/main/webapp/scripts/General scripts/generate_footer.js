...
function generateFooter() {
    ...
    companyLogo.innerHTML = `
      <img src="/TransitEase_travel_agency/Assets/images/7c829fba9e354e7d96fe6a44cd79f823.png" alt="logo">
...
function createSocialLinks(title, platforms) {
    ...
    platforms.forEach(platform => {
        const linkItem = document.createElement('li');
        linkItem.innerHTML = `<a href="#"><img src="/TransitEase_travel_agency/Assets/icons/icons8-${platform}.svg" alt="${platform}" title="Follow us on ${platform}"></a>`;
